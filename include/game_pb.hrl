...
-record(m__fight__online__s2l, {msg_id=15019, duty, game_state, round, wait_op, die_list, seat_id, attach_data1, attach_data2, offline_list, leave_list, flop_list, winner, wait_op_list, jingzhang, lover_list}).
