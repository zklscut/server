...
-record(m__player__info__s2l, {msg_id=12002, player_id, nick_name, grade, month_vip, equip, resource_list, win_rate_list, other_player, sex}).
...
-record(m__fight__result__s2l, {msg_id=15011, winner, duty_list, lover, hunxuer, daozei, mvp, carry, coin_add, cur_level, cur_exp, exp_add, pre_level_up_exp, level_up_exp, next_level_up_exp, victory_party, room_id, own_seat_id}).
...
-record(m__fight__chat_input__l2s, {msg_id=15032, is_expression, night_langren, content}).
-record(m__fight__chat_input__s2l, {msg_id=15033, is_expression, night_langren, player_id, content}).
