...
add_coin(#m__player__add_coin__l2s{}, Player) ->
  NewPlayer = mod_resource:increase(?RESOURCE_COIN, 500, ?LOG_ACTION_FIGHT, Player),
  {save, NewPlayer}.

add_diamond(#m__player__add_diamond__l2s{}, Player) ->
  NewPlayer = mod_resource:increase(?RESOURCE_DIAMOND, 500, ?LOG_ACTION_FIGHT, Player),

  {save, NewPlayer}.

upload_head(#m__player__upload_head__l2s{p_head = ImgData}, Player)->
